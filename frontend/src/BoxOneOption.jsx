...
const BoxOneOption = ({
  ...
  const getChoseTagStyles = (index) => {
    let styles = {};
    styles['border'] =
      index === chosenIndex ? '3px solid var(--accept-color)' : '0px';
    index === chosenIndex &&
      (styles['backgroundColor'] = 'rgba(25, 66, 100, 1)');
  ...
  return (
    <div className="box-one-option-container">
      <label className="box-one-option-label-title">
        {title} "{getChosenOptionName()}"
      </label>
      <div className="box-one-option-buttons-group">
