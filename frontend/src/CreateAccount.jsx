      ...
      {step === AppConst.CREATE_ACCOUNT_STEP.INPUT_NAME && (
        <div className="step-content">
          ...
          <button
            ...
            onClick={() => setStep(AppConst.CREATE_ACCOUNT_STEP.INPUT_AVATAR)}
          >
            Next
          </button>
        </div>
        ...
        <div className="step-content">
          ...
          <div className="button-group">
            <button
              ...
              onClick={() => setStep(AppConst.CREATE_ACCOUNT_STEP.INPUT_NAME)}
            >
              Back
            </button>
            {iAvatar && (
              <>
                <button className="secondary-btn" onClick={handleRemoveAvatar}>
                  Remove
                </button>
