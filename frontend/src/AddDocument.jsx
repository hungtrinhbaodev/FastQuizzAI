...
const AddDocument = ({ useDialog, closeDialog, useLoading }) => {
  ...
  const handleConfirm = () => {
    ...
    const loadingData = useLoading(
      LoadingData.makeLoading('Wait to upload your doccument!')
    );
    ...
    <>
      <div className="add-document-container">
        <div className="document-name-container">
          <label className="label-input-name label-content">
        ...
        <BoxOneOption
          ...
          defaultChosenIndex={getAllDocumentTag().indexOf(
            AppConst.DOCUMENT_TAG.OTHER
          )}
        />
        <Dropzone
        ...
        >
          ...
          {file !== null && (
            <div className="document-preview-container">
              <img src={imageUploadPDF} className="image-upload-pdf" />
              <label className="label-doc-name">{file.name}</label>
            </div>
          )}
        </Dropzone>
        <div className="process-buttons-group">
          {file != null && (
            <button
