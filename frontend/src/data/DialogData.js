...
class DialogData {
  ...
  static makeViewHistoryDetail(historyData, examDetailData) {
    return new DialogData(
      AppConst.DIALOG_USAGE.VIEW_HISTORY_DETAIL,
      'History Detail',
      true,
      '85%',
      '850px',
  ...
  copyWithSize(width, height) {
    return new DialogData(this.usage, this.title, this.canClose, width, height);
  }
}
